    ...
    <div class="container ">        
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" id="name" wire:model='location' name="name" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
                            ...
                            @if($datas!=null)
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success"  wire:click.prevent="select('{{$data['locId']}}')" data-bs-toggle="modal" data-bs-target="#editModal">
                                            ...
                                            <button class="btn btn-danger"  data-bs-toggle="modal" wire:click.prevent="select('{{$data['locId']}}')" data-bs-target="#deleteModal">
                                                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div wire:ignore.self class="modal fade" id="deleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this Location <strong> {{$location}} </strong>
                </div>
                <div class="modal-footer">
